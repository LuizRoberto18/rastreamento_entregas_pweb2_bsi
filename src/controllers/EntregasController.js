...
export class EntregasController {
   ...
   listarEntregas = async (req, res, next) => {
    try {
        ...
        // RESOLUÇÃO DO GARGALO: Conta usando SELECT COUNT() e pagina usando SKIP/TAKE no banco
        const [total, data] = await Promise.all([
            this.service.contarEntregas(filtros),
    ...
    criarEntrega = async (req, res, next) => {
        try {
            ...
            const result = await this.service.criarEntrega({ descricao, origem, destino, criadorId });
